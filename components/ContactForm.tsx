  ...
  return (
    <form noValidate onSubmit={handleSubmit}>
      ...
      <button
        ...
        className="mt-8 rounded-sm bg-ink px-5 py-2.5 text-sm font-medium text-surface transition duration-fast ease-out-expo hover:bg-ink-hover active:scale-[0.98] disabled:opacity-60"
      >
        {isSubmitting
          ? "Sending…"
          : mode === "general"
