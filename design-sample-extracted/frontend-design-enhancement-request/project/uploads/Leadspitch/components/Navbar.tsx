    ...
    <header className="sticky top-0 z-50 border-b border-hairline">
      <div className="bg-surface/70 backdrop-blur-xl">
        ...
        >
          <Link
            href="/"
            className="text-lg font-semibold tracking-tight transition-opacity duration-fast hover:opacity-70"
          ...
          <ul className="hidden items-center gap-1 md:flex">
            ...
            <li className="ml-3">
              <Link
                href={CTA_LINK.href}
                className="inline-flex items-center rounded-sm bg-ink px-4 py-2 text-sm font-medium text-surface transition duration-fast ease-out-expo hover:bg-[#2a2a2f] active:scale-[0.98]"
              >
                {CTA_LINK.label}
              </Link>
            </li>
      ...
      >
        ...
        >
          ...
          <Link
            href={CTA_LINK.href}
            className={`mt-8 inline-flex items-center justify-center rounded-sm bg-ink px-5 py-3 text-base font-medium text-surface transition-all duration-base ease-out-expo hover:bg-[#2a2a2f] active:scale-[0.98] ${
              isMenuOpen ? "translate-y-0 opacity-100" : "translate-y-1 opacity-0"
            }`}
