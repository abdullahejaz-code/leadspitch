  ...
  return (
    <article className="mx-auto max-w-2xl px-6 py-section">
      ...
      <section className="mt-20 rounded-lg border border-hairline bg-surface px-6 py-12 text-center shadow-hairline">
        ...
        <Link
          href="/contact"
          className="mt-8 inline-block rounded-sm bg-ink px-5 py-2.5 text-sm font-medium text-surface transition duration-fast ease-out-expo hover:bg-[#2a2a2f] active:scale-[0.98]"
        >
          Get in touch
        </Link>
      </section>
